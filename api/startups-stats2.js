...
exports.initial=function(app,db2,BASE_API_PATH_2,ApikeyFunction){
    
//GET/LoadInititalData


app.get(BASE_API_PATH_2 + "/startups-stats/loadInitialData", function (request, response) {
...
// GET a collection
app.get(BASE_API_PATH_2 + "/startups-stats", function (request, response) {
    //if (!ApikeyFunction(request, response)) return;
...
app.get(BASE_API_PATH_2 + "/startups-stats/:country", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
...
app.post(BASE_API_PATH_2 + "/startups-stats", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
...
app.post(BASE_API_PATH_2 + "/startups-stats/:country", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
...
app.put(BASE_API_PATH_2 + "/startups-stats", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
...
app.put(BASE_API_PATH_2 + "/startups-stats/:country", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
...
app.delete(BASE_API_PATH_2 + "/startups-stats", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
...
app.delete(BASE_API_PATH_2 + "/startups-stats/:country", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
    var country = request.params.country;
