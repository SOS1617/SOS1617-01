...
exports.initial=function(app,dba,BASE_API_PATH_2,ApikeyFunction){
    
    
    app.get(BASE_API_PATH_2 + "/youthunemploymentstats/loadInitialData", function (request, response) {
...
app.get(BASE_API_PATH_2 + "/youthunemploymentstats", function (request, response) {
   // if (!ApikeyFunction(request, response)) return;
...
app.get(BASE_API_PATH_2 + "/youthunemploymentstats/:country", function (request, response) {
...
app.post(BASE_API_PATH_2 + "/youthunemploymentstats", function (request, response) {
...
app.post(BASE_API_PATH_2 + "/youthunemploymentstats/:country", function (request, response) {
    var country = request.params.country;
 //   if(!ApikeyFunction(request,response))return;
...
app.put(BASE_API_PATH_2 + "/youthunemploymentstats", function (request, response) {
    //if(!ApikeyFunction(request,response))return;
...
app.put(BASE_API_PATH_2 + "/youthunemploymentstats/:country", function (request, response) {
   // if(!ApikeyFunction(request,response))return;
...
app.delete(BASE_API_PATH_2 + "/youthunemploymentstats", function (request, response) {
 //   if(!ApikeyFunction(request,response))return;
...
app.delete(BASE_API_PATH_2 + "/youthunemploymentstats/:country", function (request, response) {
  //  if(!ApikeyFunction(request,response))return;
    var country = request.params.country;
    if (!country) {
